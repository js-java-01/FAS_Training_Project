                ...
                {importResult && (
                    <div className="border-t pt-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div className={`p-3 rounded-lg border ${importResult.failureCount > 0 ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'
                                }`}>
                                <div className="text-xs text-gray-600 mb-1">Failed</div>
                                <div className={`text-lg font-semibold ${importResult.failureCount > 0 ? 'text-red-600' : 'text-gray-400'
                                    }`}>
