              ...
              <div className="flex gap-1 bg-white border border-gray-200 rounded-xl p-1 mb-6 shadow-sm">
                {TABS.map((tab) => (
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-semibold rounded-lg transition-all cursor-pointer ${
                      activeTab === tab.key
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                      ...
                      <div className="grid sm:grid-cols-2 gap-2.5">
                        {MOCK_OUTCOMES.map((outcome, i) => (
                          <div
                            key={i}
                            className="flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/30 transition-colors"
                          >
                            <CheckCircle
                              size={15}
                    ...
                    <div className="divide-y divide-gray-50">
                      {[
                        ...
                        },
                        {
                          ...
                          desc: "Build real projects from scratch and apply your knowledge.",
                          duration: "~4 hours",
                          items: 10,
                        ...
                        >
                          <div
                            className={`w-9 h-9 rounded-xl bg-linear-to-br ${mod.color} text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-sm`}
                          >
                            {mod.num}
                          </div>
                          <div className="flex-1 min-w-0">
