...
import { ExportSelectButton } from "@/components/ExportSelectButton.tsx";
...
export const UserManagement: React.FC = () => {
    ...
    const handleCreateUser = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setNewUser({ email: "", password: "", firstName: "", lastName: "", roleId: "" });
            loadData();
        } catch (error: any) {
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {users.map((user) => (
                            <tr key={user.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <span
                                        className={`px-2 py-1 text-xs rounded-full ${user.isActive ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                            }`}
                                    >
