    ...
    return (
        ...
        >
            <div className="flex items-start gap-4">
                ...
                <div>
                    <p className="text-sm text-gray-900 font-medium">Are you sure you want to delete this assessment?</p>
                    <p className="mt-1 text-sm text-gray-500">
                        This action cannot be undone. This will permanently delete
                        <span className="font-semibold text-gray-700"> "{assessment?.title}"</span>
                        {assessment?.code && <span className="font-mono text-gray-700"> ({assessment.code})</span>}.
                    </p>
                </div>
            </div>
        </Modal>
