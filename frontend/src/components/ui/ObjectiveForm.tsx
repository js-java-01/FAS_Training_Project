...
/**
 * Base reusable Objective type
 * Dùng chung cho Topic / Course / Program
 */
export interface BaseObjectiveFormData {
  code: string;
  name: string;
  description?: string;
...
interface ObjectiveFormProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (data: BaseObjectiveFormData) => void;
  loading?: boolean;
  initialData?: BaseObjectiveFormData | null;
  showStatus?: boolean; // cho phép bật/tắt status
}
