...
public interface ModuleGroupsRepository extends JpaRepository<ModuleGroups, UUID> {
    ...
    /*
     * UPDATE (Move UP): Chuyển từ dưới lên trên (VD: 5 -> 2) Logic: Các phần tử nằm
     * trong khoảng [newOrder, oldOrder) sẽ tăng lên 1
     */
    @Modifying
    ...
    /*
     * UPDATE (Move DOWN): Chuyển từ trên xuống dưới (VD: 1 -> 3) Logic: Các phần tử
     * nằm trong khoảng (oldOrder, newOrder] sẽ giảm đi 1
     */
    @Modifying
