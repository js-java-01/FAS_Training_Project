...
import com.example.starter_project_2025.system.dataio.importer.resolver.RelationGraphBuilder;
    ...
    private void runPostImportHooks(Object entity) {
        ...
        for (var method : entity.getClass().getDeclaredMethods()) {
            ...
            if (method.isAnnotationPresent(
                    com.example.starter_project_2025.system.dataio.importer.annotation.PostImport.class)) {
