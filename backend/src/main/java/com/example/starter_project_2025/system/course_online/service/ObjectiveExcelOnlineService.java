...
public class ObjectiveExcelOnlineService {
    ...
    public byte[] exportObjectives(UUID courseId) throws IOException {
        ...
        List<CourseObjectiveOnline> objectives =
    ...
    public void importObjectives(String courseId, MultipartFile file) throws IOException {
        ...
        CourseOnline course = courseRepository.findById(UUID.fromString(courseId))
        ...
        for (Row row : sheet) {
            ...
            CourseObjectiveOnline objective = new CourseObjectiveOnline();
