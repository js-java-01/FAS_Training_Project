...
import com.example.starter_project_2025.system.course_online.service.MaterialOnlineService;
...
@Tag(name = "MaterialOnline Management", description = "APIs for managing course materials (videos, documents, links, etc.)")
@SecurityRequirement(name = "Bearer Authentication")
public class MaterialOnlineController {

    private final MaterialOnlineService materialService;

    @PostMapping
    @Operation(summary = "Create a new material", description = "Attach a material (video, document, link, etc.) to a session")
    public ResponseEntity<MaterialOnlineResponse> createMaterial(@Valid @RequestBody MaterialOnlineRequest request) {
    ...
    public ResponseEntity<MaterialOnlineResponse> uploadMaterial(
    ...
    public ResponseEntity<MaterialOnlineResponse> updateMaterial(
            @PathVariable UUID id,
            @Valid @RequestBody MaterialUpdateOnlineRequest request) {
    ...
    public ResponseEntity<MaterialOnlineResponse> getMaterialById(@PathVariable UUID id) {
    ...
    public ResponseEntity<List<MaterialOnlineResponse>> getMaterialsBySession(@PathVariable UUID sessionId) {
    ...
    public ResponseEntity<List<MaterialOnlineResponse>> getActiveMaterialsBySession(@PathVariable UUID sessionId) {
