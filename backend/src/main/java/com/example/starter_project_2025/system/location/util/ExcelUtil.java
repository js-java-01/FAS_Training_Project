...
public class ExcelUtil {
    ...
    public static byte[] generateLocationImportTemplate() {
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            example.createCell(0).setCellValue("FPT Training Center");
            example.createCell(1).setCellValue("Hoa Lac");
            example.createCell(2).setCellValue("Hà Nội");
            example.createCell(3).setCellValue("Thạch Thất");
            ...
            throw new RuntimeException("Generate template failed", e);
        }
    }
