...
public class MfaService {
    ...
    /**
     * Verify TOTP code without lockout (used during initial setup)
     */
    @Transactional
    public boolean verifyCodeForSetup(UUID userId, String code) {
        ...
        if (isValid && credential.getFailedAttempts() > 0) {
