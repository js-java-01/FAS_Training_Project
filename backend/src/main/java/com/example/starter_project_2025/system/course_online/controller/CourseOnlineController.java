...
import com.example.starter_project_2025.system.course_online.service.CourseOnlineService;
...
@Tag(name = "CourseOnline Management", description = "CourseOnline management APIs")
@SecurityRequirement(name = "bearerAuth")
public class CourseOnlineController {

        private final CourseOnlineService courseService;

        @PostMapping
        @PreAuthorize("hasAuthority('COURSE_CREATE')")
        @Operation(summary = "Create course")
        public ResponseEntity<CourseOnlineResponse> create(@RequestBody CourseCreateOnlineRequest request) {
        ...
        public ResponseEntity<CourseOnlineResponse> update(@PathVariable UUID id,
                        @RequestBody CourseUpdateOnlineRequest request) {
        ...
        public ResponseEntity<CourseOnlineResponse> getById(@PathVariable UUID id) {
        ...
        public ResponseEntity<Page<CourseOnlineResponse>> getAll(
