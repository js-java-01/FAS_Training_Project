...
import com.example.starter_project_2025.system.course_online.dto.CourseCreateRequest;
import com.example.starter_project_2025.system.course_online.dto.CourseResponse;
import com.example.starter_project_2025.system.course_online.dto.CourseUpdateRequest;
...
public class CourseServiceImpl implements CourseService {
    ...
    private final CourseAssessmentSchemeService courseAssessmentSchemeService;
    ...
    public Page<CourseResponse> getAll(String keyword, String status, String trainerId, Pageable pageable) {
        com.example.starter_project_2025.system.course_online.enums.CourseStatus statusEnum = null;
        if (status != null && !status.isBlank()) {
            try {
                statusEnum = com.example.starter_project_2025.system.course_online.enums.CourseStatus
