...
import com.example.starter_project_2025.system.course_online.dto.ObjectiveUpdateRequest;
...
import com.example.starter_project_2025.system.course_online.mapper.CourseObjectiveMapper;
import com.example.starter_project_2025.system.course_online.repository.CourseObjectiveRepository;
...
public class CourseObjectiveServiceImpl implements CourseObjectiveService {
    ...
    public void cloneFromTopic(UUID courseId, UUID topicId) {
        ...
        List<CourseObjective> existing = repository.findByCourseId(courseId);
        ...
        for (TopicObjective topicObj : topicObjectives) {
            CourseObjective courseObj = CourseObjective.builder()
