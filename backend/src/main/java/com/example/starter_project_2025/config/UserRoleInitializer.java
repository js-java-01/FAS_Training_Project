...
public class UserRoleInitializer {
        ...
        private void assignRoleIfNotFound(User user, Role role, boolean isDefault) {
                var existing = userRoleRepository.findByUserAndRole(user, role);
                if (existing.isEmpty()) {
                        ...
                        // Correct stale isDefault values from previous initializer runs
                        UserRole existingRole = existing.get();
                        if (existingRole.isDefault() != isDefault) {
                                existingRole.setDefault(isDefault);
        ...
        public void initializeUserRoles() {
                ...
                assignRoleIfNotFound(superadmin, adminRole, false);
                assignRoleIfNotFound(superadmin, studentRole, false);
